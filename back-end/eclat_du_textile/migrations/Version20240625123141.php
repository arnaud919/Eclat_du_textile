 ...
 */
final class Version20240625123141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_article ADD name_subcategory_article_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_article DROP name_subcategory_article_id');
    }
}
